...
# ========================= CONSTANTS ============================
UNAPPROVED_MSG = (
    "`Uh Oh! This is RexKev's Bot.\n\n`"
    "`He hasn't approved you to PM him yet.`"
    "`Please wait for him to look in, He mostly approves PMs, so Chill.\n\n`"
    "`Until then, please don't spam, you'll get blocked and reported!`")
# =================================================================
